import { Settings, LogOut, Headphones, type LucideIcon } from "lucide-react";
...
function MenuItem({
  ...
  return (
    ...
    >
      <div className="size-9 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] flex items-center justify-center text-[var(--color-icon-default)] shrink-0">
        <Icon size={16} />
      </div>
